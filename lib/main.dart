...
class _HomeState extends State<Home> {
  ...
  void _calculate() {
    setState(() {
      ...
      if (imc < 18.6) {
        _infoText = "Você está abaixo do peso! seu IMC é (${imc.toStringAsPrecision(3)})";
      } else if (imc >= 18.6 && imc < 24.9) {
        _infoText = "Peso ideal! seu IMC é (${imc.toStringAsPrecision(3)})";
      } else if (imc >= 24.9 && imc < 29.9) {
        _infoText = "Levemente acima do peso! seu IMC é (${imc.toStringAsPrecision(3)})";
